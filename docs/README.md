...
Toda a lógica de cálculo do sistema é baseada na tabela movimentacoes. Dessa forma, evita-se duplicação de informações e inconsistências nos valores armazenados.
